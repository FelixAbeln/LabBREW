...
class MainWindow(QMainWindow):
    ...
    def _apply_styles(self) -> None:
        ...
        self.confirm_banner.setStyleSheet(
            "background: #dcfce7; color: #166534; border: 1px solid #86efac; border-radius: 8px; padding: 10px; font-weight: 700;"
        )
    ...
    def _set_button_role_style(self, button: QPushButton, role: str, blink_on: bool = False) -> None:
        ...
        button.setStyleSheet(
            f"background: {bg}; color: {fg}; border: 1px solid #94a3b8; border-radius: 8px; padding: 8px 16px; font-weight: 700;"
        )
