...
class ParquetWriter(FileWriter):
    ...
    def _get_filepath(self) -> str:
        """Get the output file path."""
        return os.path.join(self.output_dir, f"{self.session_name}.parquet")
...
class CSVWriter(FileWriter):
    ...
    def _get_filepath(self) -> str:
        """Get the output file path."""
        return os.path.join(self.output_dir, f"{self.session_name}.csv")
...
class JSONLWriter(FileWriter):
    ...
    def _get_filepath(self) -> str:
        """Get the output file path."""
        return os.path.join(self.output_dir, f"{self.session_name}.jsonl")
...
class FileWriterFactory:
    ...
    @staticmethod
    def create(format_type: str, output_dir: str, session_name: str,
               parameters: list[str]) -> FileWriter:
