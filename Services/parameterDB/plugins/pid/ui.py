def get_ui_spec() -> dict:
    return {
        ...
        "description": "Reads PV and SP from other parameters and can mirror its output to one or more other parameters.",
        "create": {
            "required": [
                "name",
                "config.pv",
                    ...
                    "fields": [
                        {
                            ...
                            "type": "parameter_ref",
                            "required": True,
                            "help": "Parameter that provides the measured process value.",
                        },
                        {
                            "key": "config.sp",
                            "label": "Setpoint",
                        ...
                        },
                        {
                            ...
                            "type": "parameter_ref",
                            "help": "Optional boolean-like parameter used to enable or disable controller action.",
                        },
                        {
                            "key": "config.mode_param",
                            "label": "Mode Parameter",
                            "type": "parameter_ref",
                            "help": "Optional parameter that selects auto/manual mode externally.",
                        },
                        {
                            "key": "config.manual_out_param",
                            "label": "Manual Output Parameter",
                            "type": "parameter_ref",
                            "help": "Optional parameter providing manual output when the controller is not in auto.",
                        },
                        {
                            "key": "config.output_params",
                            "label": "Mirror Output To",
                            "type": "parameter_ref",
                            "help": "Optional parameters that should receive the same output value as this PID controller.",
                        },
                    ],
                },
                {
                    "title": "Tuning",
                    "fields": [
                        {"key": "config.kp", "label": "Kp", "type": "float", "required": True, "help": "Proportional gain."},
                        {"key": "config.ki", "label": "Ki", "type": "float", "required": True, "help": "Integral gain per scan."},
                        {"key": "config.kd", "label": "Kd", "type": "float", "required": True, "help": "Derivative gain."},
                        {"key": "config.bias", "label": "Bias", "type": "float", "help": "Constant output bias added before clamping."},
                        {"key": "config.out_min", "label": "Output Min", "type": "float", "required": True, "help": "Lower output clamp."},
                        {"key": "config.out_max", "label": "Output Max", "type": "float", "required": True, "help": "Upper output clamp."},
                    ],
                },
                {
                    ...
                    "fields": [
                        {
                            ...
                            "type": "float",
                            "help": "Initial stored controller output before the first useful scan.",
                        },
                        {
                            "key": "config.manual_out",
                            "label": "Manual Output",
                            "type": "float",
                            "help": "Fallback manual output when no manual output parameter is wired.",
                        },
                    ],
                },
            ],
