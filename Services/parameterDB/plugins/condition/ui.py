def get_ui_spec() -> dict:
    return {
        ...
        "description": (
            "Evaluates shared wait-expression logic like cond:..., "
            "elapsed:..., all(...), and any(...), then stores the "
            "resulting boolean."
        ),
        "create": {
                    ...
                    "fields": [
                        {
                            ...
                            "help": (
                                ...
                                "elapsed:seconds, all(expr1;expr2), or "
                                "any(expr1;expr2). Example: "
                    ...
                    "fields": [
                        {
                            ...
                            "type": "bool",
                            "help": (
                                "Stored boolean value before the first "
            ...
            "sections": [
                {
                    ...
                    "fields": [
                        ...
                        },
                        {
                            ...
                            "type": "readonly",
                            "help": (
                                "Final boolean result from the latest "
                ...
                },
                {
                    ...
                    "fields": [
                        ...
                        {
                            "key": "state.logic_kind",
                            "label": "Logic Kind",
                            "type": "readonly",
                        },
                        {
                            "key": "state.condition_kind",
                        ...
                        {
                            "key": "state.elapsed_s",
                            "label": "Elapsed Since Start (s)",
                            "type": "readonly",
                        },
                        {
                            "key": "state.required_for_s",
                            "label": "Required Hold (s)",
                            "type": "readonly",
                        },
                        {
                            "key": "state.observed_values",
