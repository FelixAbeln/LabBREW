def get_ui_spec() -> dict:
    return {
        ...
        "description": (
            "Computes rate-of-change from one source parameter "
            "using scan dt."
        ),
        "create": {
            ...
            "sections": [
                {
                    ...
                    "fields": [
                        ...
                        },
                        {
                            ...
                            "type": "float",
                            "help": (
                                "Starting output value before the first "
                                "derivative sample."
                            ),
                        },
                    ],
                    ...
                    "fields": [
                        {
                            ...
                            "required": True,
                            "help": (
                                "Parameter whose rate-of-change should be "
                                "computed."
                            ),
                        },
                        {
                    ...
                    "fields": [
                        {
                            ...
                            "help": (
                                "Use 'continuous' for time since last "
                                "detected source change. Use 'window' for "
                                "derivative over a fixed trailing time window."
                            ),
                        },
                        {
                            "key": "config.window_s",
                            ...
                            "help": (
                                "Used when mode is 'window'. Example: 2.0 "
                                "gives a two-second trailing derivative."
                            ),
                        },
                        {
                            "key": "config.scale",
                        ...
                        },
                        {
                            ...
                            "help": (
                                "Lower bound used for dt to avoid "
                ...
                },
                {
                    ...
                    "fields": [
                        {"key": "state.mode", "label": "Mode", "type": "readonly"},
                        {
                            ...
                            "label": "Window",
                            "type": "readonly",
                            "visible_when": {"state.mode": "window"},
                        },
                        ...
                        {
                            "key": "state.raw_derivative",
                            "label": "Raw Derivative",
                            "type": "readonly",
                        },
                        {
                            "key": "state.updated_on_change",
                            "label": "Updated On Change",
                            "type": "readonly",
                        },
                        {"key": "state.scale", "label": "Scale", "type": "readonly"},
                        {"key": "state.dt", "label": "dt", "type": "readonly"},
                        {
                            "key": "state.effective_dt",
                            "label": "Effective dt",
                            "type": "readonly",
                        },
                        {
                            "key": "state.elapsed_since_change_s",
                            "label": "Elapsed Since Change",
                            "type": "readonly",
                            "visible_when": {"state.mode": "continuous"},
                        },
                        {
                            "key": "state.history_sample_count",
                            "label": "History Samples",
                            "type": "readonly",
                            "visible_when": {"state.mode": "window"},
                        },
                        {
                            "key": "state.history_span_s",
                            "label": "History Span",
                            "type": "readonly",
                            "visible_when": {"state.mode": "window"},
                        },
