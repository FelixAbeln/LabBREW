...
def _transport_section() -> dict:
    return {
        ...
        "fields": [
            ...
            {"key": "config.gateway_control_port", "label": "PCAN Gateway Control Port", "type": "int", "required": True, "hint": "TCP control-plane port (typically 45321).", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_control_enabled", "label": "Enable Gateway Control Plane", "type": "bool", "required": False, "hint": "Prefilled and recommended ON.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_route_name", "label": "Gateway Route Name", "type": "string", "required": False, "hint": "Prefilled route identifier (normally leave as rt2).", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_route_state", "label": "Gateway Route State", "type": "string", "required": False, "hint": "Prefilled route state (normally leave unchanged).", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_auth_token", "label": "Gateway Auth Token", "type": "string", "required": False, "hint": "Prefilled auth token. Change only for different gateway auth config.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_auth_id", "label": "Gateway Auth ID", "type": "string", "required": False, "hint": "Prefilled auth ID.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_send_fw_dev_probes", "label": "Send FW/DEV Probes", "type": "bool", "required": False, "hint": "Prefilled and recommended ON.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_control_tick_s", "label": "Gateway Control Tick (s)", "type": "float", "required": False, "hint": "Shared keepalive interval for TX/RX routes.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_control_timeout_s", "label": "Gateway Control Timeout (s)", "type": "float", "required": False, "hint": "Shared control-plane timeout for TX/RX.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_rx_control_enabled", "label": "Enable RX Route Hold", "type": "bool", "required": False, "hint": "Maintain RX route on gateway for route parity.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_rx_route_name", "label": "RX Route Name", "type": "string", "required": False, "hint": "Prefilled from capture (rt1).", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_rx_route_state", "label": "RX Route State", "type": "string", "required": False, "hint": "Prefilled from capture (0x08000002).", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_rx_auth_token", "label": "RX Auth Token", "type": "string", "required": False, "hint": "Prefilled from capture; normally unchanged.", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            {"key": "config.gateway_rx_update_state", "label": "RX Update State", "type": "string", "required": False, "hint": "Route state for keepalive (0xc000002).", "visible_when": {"config.transport": "pcan_gateway_udp"}},
            ...
            "menu": {
                ...
                "result": {
                    ...
                    "apply_map": {
                        ...
                        "gateway_control_enabled": "gateway_control_enabled",
                        "gateway_route_name": "gateway_route_name",
                        "gateway_route_state": "gateway_route_state",
                        "gateway_auth_token": "gateway_auth_token",
                        "gateway_auth_id": "gateway_auth_id",
                        "gateway_send_fw_dev_probes": "gateway_send_fw_dev_probes",
                        "gateway_control_tick_s": "gateway_control_tick_s",
                        "gateway_control_timeout_s": "gateway_control_timeout_s",
                        "gateway_rx_control_enabled": "gateway_rx_control_enabled",
                        "gateway_rx_route_name": "gateway_rx_route_name",
                        "gateway_rx_route_state": "gateway_rx_route_state",
                        "gateway_rx_auth_token": "gateway_rx_auth_token",
                        "gateway_rx_update_state": "gateway_rx_update_state",
