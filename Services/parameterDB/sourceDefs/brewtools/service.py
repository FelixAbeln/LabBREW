    ...
    def _connect_transport(self):
        ...
        if transport_name == "kvaser":
            ...
            self._transport = PeakGatewayUdpTransport(
                ...
                control_enabled=False,  # FORCE DISABLED: TCP control overhead removed
                ...
                send_fw_dev_probes=False,  # FORCE DISABLED
                ...
                rx_control_enabled=False,  # FORCE DISABLED: RX control overhead removed
