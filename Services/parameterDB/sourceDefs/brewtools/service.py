...
class BrewtoolsSource(DataSourceBase):
    ...
    def _connect_transport(self):
        ...
        if transport_name == "kvaser":
            ...
            self._transport = PeakGatewayUdpTransport(
                ...
                control_enabled=bool(self.config.get("gateway_control_enabled", False)),
                ...
                send_fw_dev_probes=bool(self.config.get("gateway_send_fw_dev_probes", False)),
                ...
                rx_control_enabled=bool(self.config.get("gateway_rx_control_enabled", False)),
                ...
                rx_auth_token=str(self.config.get("gateway_rx_auth_token", "")),
    ...
    def _build_pwm_frame(self, *, node_id: int, duty_cycle: float) -> RawCanFrame:
        ...
        # Firmware expects uint32 big-endian: subindex (1 byte) + value (4 bytes)
        frame = CanFrame(can_id=can_id, body=RawBody(subindex=0, raw=int(pct).to_bytes(4, "big")))
...
class BrewtoolsSourceSpec(DataSourceSpec):
    ...
    def default_config(self) -> dict[str, Any]:
        return {
            ...
            "gateway_send_fw_dev_probes": False,
            "gateway_control_tick_s": 1.0,
            "gateway_control_timeout_s": 1.5,
            "gateway_rx_control_enabled": False,
