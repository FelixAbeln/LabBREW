...
class _NavigationMixin:
    ...
    def _advance_step_locked(
        self, schedule: ScheduleDefinition, manual: bool = False
    ) -> None:
        ...
        Exit loadsteps are only triggered via the natural _tick path,
        never on manual Next.
        """
        steps = self._phase_steps(schedule)
