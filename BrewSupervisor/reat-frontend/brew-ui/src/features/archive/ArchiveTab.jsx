    ...
    <div className="tab-content-grid">
      <div className="info-card archive-summary-card">
        <div className="control-bar-copy">
          ...
          <span>
            Compressed run bundles ({archives.length})
        ...
        {!disk ? (
          ...
          <div className="archive-disk-grid">
            <div className="archive-disk-card">
              <span className="small-text">Free</span>
              <strong>{formatBytes(disk.free_bytes)}</strong>
            </div>
            <div className="archive-disk-card">
              <span className="small-text">Used</span>
                  ...
                  <div key={name} className="archive-table-row">
                    ...
                    <div className="button-row compact-actions">
                      ...
                      <button
                        ...
                        disabled={deletingArchiveName === name || !name}
