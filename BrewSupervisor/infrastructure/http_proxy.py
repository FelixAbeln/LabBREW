...
class HttpServiceProxy:
    ...
    def request_raw(self, *, method: str, url: str, params: dict[str, Any] | None = None, json_body: Any = None) -> requests.Response:
        return self._session.request(method=method.upper(), url=url, params=params, json=json_body, timeout=self.timeout_s)
