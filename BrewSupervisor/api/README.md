...
- Dry-run validation is available via `PUT /fermenters/{fermenter_id}/scenario/validate-import`.
- Import is available via `PUT /fermenters/{fermenter_id}/scenario/import`.
